            ...
            <ul class="nav navbar-nav flex-row">
                ...
                <li class="nav-item">
                    <a class="navbar-brand" href="{{route('dashboard')}}">
                        ...
                        <h5 class="brand-text"><b> ERP-Marchantizing </b></h5>
                    </a>
                </li>
        ...
        <div class="navbar-container content">
            <div class="collapse navbar-collapse" id="navbar-mobile">
                ...
                <ul class="nav navbar-nav float-right">
                    <li clas="nav-item" style="padding-top: 5px;">
                        @php
                            $menuList = [];
                            $sessionMenus = \Illuminate\Support\Facades\Session::get('menus');
                        ...
                        @endphp
                        <select name="" id="menuSelect" class="select2">
                            <option value="">Select menu</option>
                            @foreach($menuList as $menu)
                            <option value="{{ route($menu['menu_url']) }}"
                            @if(\Request::url() == route($menu['menu_url'])) selected @endif
                            >{{ $menu['name'] }}</option>
                            @endforeach
                        </select>
                    </li>
