<template>
    <ul class="pagination justify-content-center" v-if="resultData.last_page > 1">
        ...
        <li class="page-item" :class="{ disabled: resultData.current_page <= 1 }">
            <a class="page-link" @click.prevent="pageClicked(1)"  ><b>First page</b></a>
        </li>
        ...
        <li class="page-item" :class="{ disabled: resultData.current_page >= resultData.last_page }">
            <a class="page-link" @click.prevent="pageClicked(resultData.last_page)"><b>Last page</b></a>
        </li>
