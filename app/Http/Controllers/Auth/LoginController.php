    ...
    public function login(Request $request)
    {
        ...
        if ($this->attemptLogin($request)) {
            ...
            */
            ...
            $permission_menu_for_sideber_show =  json_decode(AclMenu::select(DB::raw('acl_menus.id, acl_menus.name, acl_menus.menu_url, acl_menus.parent_id, acl_menus.module_id,acl_menus.status'))
            ...
            session()->put('loged_user_role', (AclRole::where('role_id', Auth::user()->role_id)->first() ? AclRole::where('role_id', Auth::user()->role_id)->first()->role_name : NULL));
